...
export function ThemeToggle(): ReactElement | null {
  ...
  return (
    <button
      ...
      className="fixed top-6 right-6 z-50 p-3 rounded-full bg-white/10 backdrop-blur-lg border border-white/20 hover:bg-white/20 transition-all duration-300 shadow-lg hover:shadow-xl group"
